...
./exam-system.sh start       # Linux/macOS -- starts both backend and frontend
./exam-system.sh stop
./exam-system.sh restart
./exam-system.sh status

# Windows
exam-system.bat start
exam-system.bat stop
exam-system.bat restart
exam-system.bat status
...
exam-system.sh/.bat   Unified start/stop/status scripts
```
...
- **BAT script hardcodes JDK path** -- `exam-system.bat` has `JAVA_HOME=C:\Program Files\Java\jdk-17.0.2`. May need adjustment per machine.
