...
public class WeatherData implements Comparable<WeatherData> {
    ...
    public WeatherData() {}
    public WeatherData(String id, String name) { this.id = id; this.name = name; }
    ...
    @Override
    public int compareTo(WeatherData other) { return this.id.compareTo(other.id); }
    @Override
    public String toString() { return "WeatherData{id='" + id + "', name='" + name + "'}"; }
}
